...
import { CardCol, CardsCols, ContainerBack, ContainerCardBlock, ContainerCardsWrapper, ContainerFront, Fog, Fog2, Fog3, Fog4, Fog5, FogClearDay, FogClearDay2, Frame, FrameClearDay, HexagonAndCardGrid, InfoBlock, Sum, Thing } from "./cardBlockStyle";
                                ...
                                <ContainerCardBlock>
                                    {item.data.rain > 0 ?
                                        ...
                                        <ContainerFront blockselect={item.blockId === '222'} className="front" onClick={() => true}>
                                            <FrameClearDay>
                                                <Sum></Sum>
                                                <FogClearDay className="grayscale saturate-ver2" src="https://www.freepnglogos.com/uploads/cloud-png/cloud-clipart-30.png" />
                                                <InfoBlock className="infoBlock">
                                                    <p>{item.abrv}</p>
                                                    <span>{item.name}</span>
