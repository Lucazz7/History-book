              ...
              <CardsCols>
                <CardCol>
                  <ContainerCardBlock>
                    {item.data.rain > 0 ? (
                      <ContainerFront
                        blockselect={item.blockId === "222"}
                        className="front"
                        onClick={() => true}
                      >
                        <Frame>
                          <Fog
                            className="grayscale saturate-ver5"
                            src="https://www.freepnglogos.com/uploads/cloud-png/small-single-cloud-image-transparent-20.png"
                          />
                          <Fog2
                            className="grayscale saturate-ver1"
                            src="https://www.freepnglogos.com/uploads/cloud-png/small-single-cloud-image-transparent-20.png"
                          />
                          <Fog3
                            className="grayscale saturate-ver2"
                            src="https://www.freepnglogos.com/uploads/cloud-png/small-single-cloud-image-transparent-20.png"
                          />
                          <Fog
                            className="grayscale saturate-ver3"
                            src="https://www.freepnglogos.com/uploads/cloud-png/small-single-cloud-image-transparent-20.png"
                          />
                          <Fog4
                            className="grayscale saturate-ver2"
                          ...
                          />
                          <Fog5
                            className="grayscale saturate-ver4"
                            src="https://www.freepnglogos.com/uploads/cloud-png/small-single-cloud-image-transparent-20.png"
                          />
                      ...
                      >
                        <FrameClearDay>
                          ...
                          <FogClearDay
                            className="grayscale saturate-ver2"
                            src="https://www.freepnglogos.com/uploads/cloud-png/cloud-clipart-30.png"
                          />
                          <InfoBlock className="infoBlock">
                            <p>{item.abrv}</p>
                            <span>{item.name}</span>
