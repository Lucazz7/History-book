...
import { CheckBox } from "../../CheckBox/CheckBoxDefault/CheckBox";
    ...
    >
      {isHistory !== undefined && isHistory ? (
        <Button
          ...
          onClick={() => setModalOpen(editOrCreated)}
        >
          Abrir modal
        </Button>
      ) : (
          ...
          <Modal.Body>
            {editOrCreated !== "delete" ? (
              <>
                <div>
                  ...
                  <Input
                    ...
                    style={
                      false
                        ? {
                            backgroundColor: "rgb(210,210,210, 0.2)",
                            color: "white",
                            border: "1px solid rgb(210,210,210, 0.2)",
                          }
                ...
                <p style={{ fontWeight: "bold", fontSize: "1.8rem" }}>Abrv:</p>
                <Input
            ...
            {editOrCreated === "edit" ? (
              <ComboBoxDefault
                widthComboBox={"100%"}
                option={parametersListEdit}
                messageComboBox="Selecione algo por favor"
              ></ComboBoxDefault>
            ) : (
              ""
            )}
            {editOrCreated === "create" ? (
              <>
                <p>Arquivo KML</p>
                <CheckBox
                  setClick={setLeafParent}
                  changeBoolean={leafParentTrue}
                  onChange={() => setLeafParent(!leafParentTrue)}
                />
